  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.minecraft = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${pkgs.temurin-jre-bin}/bin/java -Xms2g -Xmx4g -XX:+UseG1GC -Dsun.rmi.dgc.server.gcInterval=2147483646 -XX:+UnlockExperimentalVMOptions -XX:G1NewSizePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -jar forge.jar";
